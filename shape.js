...
export class Shape {
  ...
  static MASK_S = [0, 0x6, 0x66, 0x666, 0x6666];
  static MASK_W = [0, 0xc, 0xcc, 0xccc, 0xcccc];
  static MASK_N = [0, 0x9, 0x99, 0x999, 0x9999];

  static LOGO_E = [[], [], [0x12, 0x21], [0x121, 0x212], [0x1212, 0x2121]];
